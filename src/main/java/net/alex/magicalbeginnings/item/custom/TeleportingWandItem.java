...
public class TeleportingWandItem extends Item {
    ...
    public TeleportingWandItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        ItemStack wand = new ItemStack(ModItems.TELEPORTING_WAND);
        ...
        if (!world.isClient) {
            ...
            if (currentMana > manaCost){
                ...
                if(user.isSneaking()){
                    ...
                    user.teleport(xCoordinate, yCoordinate, zCoordinate);
                }else{
                    ...
                    // create a new proj
                    TeleportOrbEntity persistentProjectileEntity = new TeleportOrbEntity(world, user);
