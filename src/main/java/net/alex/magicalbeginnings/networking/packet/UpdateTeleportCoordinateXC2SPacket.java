 ...
 */
public class UpdateTeleportCoordinateXC2SPacket {
    /**
    ...
    public static void receive(MinecraftServer server, ServerPlayerEntity player, ServerPlayNetworkHandler handler,
        ...
        double coordinateX = buf.readDouble();

        TeleportationData.updateCoordinateX((IEntityDataSaver) player, coordinateX);

        TeleportationData.syncCoordinateX(((IEntityDataSaver) player).getPersistentData().getDouble("teleportationCoordinateX"), player);
    }
}
