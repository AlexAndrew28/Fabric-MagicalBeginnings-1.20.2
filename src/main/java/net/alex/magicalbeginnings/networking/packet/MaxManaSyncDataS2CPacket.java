...
/**
 * A packet that syncs max mana
 * Goes from server to client
 */
public class MaxManaSyncDataS2CPacket {
    /**
     * Update the saved value for the max mana
     *
    ...
    public static void receive(MinecraftClient client, ClientPlayNetworkHandler handler,
        ...
        if(client.player != null) {
            ((IEntityDataSaver) client.player).getPersistentData().putInt("maxMana", buf.readInt());
        }
    }
}
