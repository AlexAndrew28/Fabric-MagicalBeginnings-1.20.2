 ...
 */
public class TeleportationCoordinateYSyncS2CPacket {

    /**
     * Update the saved value for the y coordinate of the players teleportation data
     *
    ...
    public static void receive(MinecraftClient client, ClientPlayNetworkHandler handler,
        ...
        if(client.player != null){
            ((IEntityDataSaver) client.player).getPersistentData().putDouble("teleportationCoordinateY", buf.readVec3d().getY());
        }
